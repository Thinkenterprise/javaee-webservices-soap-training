 ...
 * 
 */
@WebServiceClient(name = "ATMService", targetNamespace = "http://www.fi.de/atm", wsdlLocation = "file:/C:/user/schaefer/home/projects/trainer/jax-ws/workspace/jaxws-deployment-start/jws-deployment-tomcat-start/WebContent/WEB-INF/wsdl/ATMService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/user/schaefer/home/projects/trainer/jax-ws/workspace/jaxws-deployment-start/jws-deployment-tomcat-start/WebContent/WEB-INF/wsdl/ATMService.wsdl");
