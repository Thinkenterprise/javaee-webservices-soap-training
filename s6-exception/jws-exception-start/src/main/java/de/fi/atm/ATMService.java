 ...
 * 
 */
@WebServiceClient(name = "ATMService", targetNamespace = "http://www.fi.de/atm", wsdlLocation = "file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s6-jws-exception-sample/jws-exception/res/ATMService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s6-jws-exception-sample/jws-exception/res/ATMService.wsdl");
