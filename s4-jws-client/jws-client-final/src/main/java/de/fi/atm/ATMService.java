 ...
 * 
 */
@WebServiceClient(name = "ATMService", targetNamespace = "http://www.fi.de/atm", wsdlLocation = "file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s4-jws-client-sample/jws-client-final/res/ATMService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s4-jws-client-sample/jws-client-final/res/ATMService.wsdl");
