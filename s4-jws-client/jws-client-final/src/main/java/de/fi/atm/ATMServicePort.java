...
public interface ATMServicePort {
     ...
     * @param parameters
     * @return
     *     returns javax.xml.ws.Response<de.fi.atm.types.ATMOrderConfirmationType>
     */
    @WebMethod(operationName = "bookTicket")
    public Response<ATMOrderConfirmationType> bookTicketAsync(
     ...
     */
    @WebMethod(operationName = "bookTicket")
    public Future<?> bookTicketAsync(
        @WebParam(name = "ATMOrder", targetNamespace = "http://www.fi.de/atm/types", partName = "parameters")
        ATMOrderType parameters,
        @WebParam(name = "bookTicketResponse", targetNamespace = "", partName = "asyncHandler")
        AsyncHandler<ATMOrderConfirmationType> asyncHandler);
