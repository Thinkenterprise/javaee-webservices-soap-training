 ...
 * 
 */
@WebServiceClient(name = "ATMService", targetNamespace = "http://www.fi.de/atm", wsdlLocation = "file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s7-jws-handler-sample/jws-handler/res/ATMService.wsdl")
@HandlerChain(file = "ATMService_handler.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/environment/source/jax-ws/java-ee-jax-ws-training/s7-jws-handler-sample/jws-handler/res/ATMService.wsdl");
